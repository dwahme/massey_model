...
if __name__ == "__main__":
    ...
    city_no = city.City(groups_no, 20)
    city_no.generate_mixed([["a", "b", ("d", 0)], ["c", ("d", 1)]])

    city_no_seg = city.City(groups_no, 20)
    city_no_seg.generate_mixed_seg([["a", "b", ("d", 0)], ["c", ("d", 1)]])

    city_lo = city.City(groups_lo, 20)
    city_lo.generate_mixed([[("a", 0), ("d", 0)], [("a", 1), "b", ("d", 1)], ["c", ("d", 2)]])

    city_lo_seg = city.City(groups_lo, 20)
    city_lo_seg.generate_mixed_seg([[("a", 0), ("d", 0)], [("a", 1), "b", ("d", 1)], ["c", ("d", 2)]])

    city_hi = city.City(groups_hi, 20)
    city_hi.generate_mixed([[("a", 0), ("d", 0)], [("a", 1), "b", ("d", 1)], ["c", ("d", 2)]])

    city_hi_seg = city.City(groups_hi, 20)
    city_hi_seg.generate_mixed_seg([[("a", 0), ("d", 0)], [("a", 1), "b", ("d", 1)], ["c", ("d", 2)]])

    city_all = city.City(groups_all, 20)
    city_all.generate_mixed([[("a", 0), ("d", 0)], ["b", ("d", 1)], ["c", ("d", 2)]])

    city_all_seg = city.City(groups_all, 20)
    city_all_seg.generate_mixed_seg([[("a", 0), ("d", 0)], ["b", ("d", 1)], ["c", ("d", 2)]])
